...
return require('packer').startup(function(use)
    ...
    use {"b0o/incline.nvim", config = function() require("incline").setup() end} -- Floating statusline
    ...
    use {'nvim-treesitter/nvim-treesitter', run = ':TSUpdate'} -- Syntax and so much more
    use {
        'ggandor/leap.nvim',
